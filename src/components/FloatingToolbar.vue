    ...
    <teleport to="body">
        ...
        >
            <div class="toolbar-container">
                ...
                <!-- 当节点被锁定或成组时，隐藏默认工具栏 -->
                <template
                    v-else-if="!selectedNodesLocked && !selectedNodesGrouped"
                >
                    <!-- 形状选择工具 -->
                    <div class="tool-group">
                    ...
                    <div class="tool-group">
                        <a-dropdown placement="bottomLeft" :trigger="['click']">
                            <a-button
                                type="text"
                                size="small"
                                class="tool-button color-button"
                            >
                                <div
                                    class="color-preview"
...
const shouldShowToolbar = computed(() => {
    ...
    const isDefaultMode =
        (editorModeStore.currentMode & EditorMode.DEFAULT) !== 0;
...
watch(
    [
        ...
        () => nodeInfoStore.groupedNodeGroups,
    ],
    ([currentSelectedNodeIds]) => {
        // 更新成组状态
        selectedNodesGrouped.value = nodeInfoStore.isGrouped(
            currentSelectedNodeIds
        );
